            ...
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-stone-300 leading-relaxed mb-8 text-base md:text-lg">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-2xl border border-stone-700"
                    >
                        <iframe
