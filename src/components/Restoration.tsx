...
import { Building2, Calendar, CreditCard, FileText, Landmark, Calculator, Send, CheckCircle } from "lucide-react";

export default function Restoration() {
    return (
        <section id="restoration" className="py-20 bg-stone-100">
            <div className="container mx-auto px-4">
                ...
                >
                    <span className="inline-block py-1 px-3 rounded-full bg-amber-100 text-amber-800 text-sm font-semibold mb-4">
                        Lei Rouanet (Art. 18) • PRONAC nº 2416522
                    </span>
                    <h2 className="text-3xl md:text-4xl font-serif font-bold text-stone-900 mb-4 max-w-4xl mx-auto">
                    ...
                    <div className="mt-6 inline-flex items-center gap-2 text-amber-700 font-medium bg-amber-50 px-4 py-2 rounded-lg border border-amber-200">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-stone-900">Faça sua Doação</h3>
                                <p className="text-stone-500">Depósito Identificado</p>
                            </div>
                        </div>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <h3 className="text-2xl font-serif font-bold text-stone-900 mb-8">Como Doar (Passo a Passo)</h3>

                        <div className="space-y-8">
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 w-10 h-10 bg-amber-600 rounded-full flex items-center justify-center text-white font-bold">1</div>
                                <div>
                                    <h4 className="text-lg font-bold text-stone-900 mb-2 flex items-center gap-2">
                                        <Calculator className="w-5 h-5 text-amber-600" /> Calcular
                                    </h4>
                            ...
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 w-10 h-10 bg-amber-600 rounded-full flex items-center justify-center text-white font-bold">2</div>
                                <div>
                                    <h4 className="text-lg font-bold text-stone-900 mb-2 flex items-center gap-2">
                                        <CreditCard className="w-5 h-5 text-amber-600" /> Depositar
                                    </h4>
                                    <p className="text-stone-600">
                            ...
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 w-10 h-10 bg-amber-600 rounded-full flex items-center justify-center text-white font-bold">3</div>
                                <div>
                                    <h4 className="text-lg font-bold text-stone-900 mb-2 flex items-center gap-2">
                                        <Send className="w-5 h-5 text-amber-600" /> Enviar Comprovante
                                    </h4>
                                    <p className="text-stone-600">
                            ...
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 w-10 h-10 bg-amber-600 rounded-full flex items-center justify-center text-white font-bold">4</div>
                                <div>
                                    <h4 className="text-lg font-bold text-stone-900 mb-2 flex items-center gap-2">
                                        <FileText className="w-5 h-5 text-amber-600" /> Declarar
                                    </h4>
                                    <p className="text-stone-600">
